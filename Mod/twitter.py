    ...
    def doLogin(self, username, password):
        ...
        if (self.driver.title.encode('ascii', 'replace').startswith(bytes("Login on", 'utf-8'))):
            ...
            try:
                ...
                print(
                    "Twitter Login Page username field seems to have changed, please make an issue on: https://github.com/malwareman007/The_Hunter")
                sys.exit()
            ...
            try:
                ...
                print(
                    "Twitter Login Page password field seems to have changed, please make an issue on: https://github.com/malwareman007/The_Hunter")
                sys.exit()
            ...
            # twLoginButton = self.driver.find_element_by_xpath("/html/body/div/div/div/div/main/div/div/form/div/div[3]/div")
                ...
                print(
                    "Twitter Login Page login button name seems to have changed, please make an issue on: https://github.com/malwareman007/The_Hunter")
                traceback.print_exc()
                sys.exit()
            # twLoginButton.click()
            sleep(5)
            ...
            print(
                "Twitter Login Page title field seems to have changed, please make an issue on: https://github.com/malwareman007/The_Hunter")
